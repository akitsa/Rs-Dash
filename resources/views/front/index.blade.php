              ...
              <div class="row">
                <div class="col-xl-3 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>Fasilitas Penunjang Medis</h4>
                    <p>Dilengkapi dengan Fasilitas yang Canggih Kami Tingkatkan Mutu Pelayanan</p>
                  </div>
                </div>
                <div class="col-xl-3 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <p>Periksakan Kesehatan Anda, Kami melayani pasien Individu dan Corporate</p>
                  </div>
                </div>
                <div class="col-xl-3 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>Rekanan RSI</h4>
                    <p>Kami melayani pasien BPJS Kesehatan, BPJS Ketenagakerjaan, Asuransi, Instansi ,dan Umum. Untuk
                      info lebih lengkap klik tombol dibawah.</p>
                  </div>
                </div>
                <div class="col-xl-3 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <p>Silahkan berkonsultasi dengan doktor kami</p>
                  </div>
                </div>
              </div>
            </div><!-- End .content-->
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="icon-box" style="--bg: url(../img/IGD.jpg);">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <h4><a href="">Penunjang Medis </a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="icon-box">
              ...
              <h4><a href="">Penunjang Non Medis</a></h4>
              <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia</p>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box" style="--bg: url(../img/Rawat_Inap.jpg);">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box" style="--bg: url(../img/Rawat_Jalan.jpg);">
            ...
            <div class="tab-content">
              <div class="tab-pane active show" id="tab-1">
                <div class="row gy-4">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="{{ asset ('front/assets/img/departments-1.jpg') }}" alt="" class="img-fluid">
                  </div>
                </div>
              </div>
              <div class="tab-pane" id="tab-2">
                <div class="row gy-4">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="{{ asset ('front/assets/img/departments-2.jpg') }}" alt="" class="img-fluid">
                  </div>
                </div>
              </div>
              <div class="tab-pane" id="tab-3">
                <div class="row gy-4">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="{{ asset ('front/assets/img/departments-3.jpg') }}" alt="" class="img-fluid">
                  </div>
                </div>
              </div>
              <div class="tab-pane" id="tab-4">
                <div class="row gy-4">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="{{ asset ('front/assets/img/departments-4.jpg') }}" alt="" class="img-fluid">
                  </div>
                </div>
              </div>
              <div class="tab-pane" id="tab-5">
                <div class="row gy-4">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="{{ asset ('front/assets/img/departments-5.jpg') }}" alt="" class="img-fluid">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="{{ asset ('front/assets/img/doctors/doctors-1.jpg') }}" class="img-fluid"
                  alt=""></div>
          ...
          <div class="col-lg-6 mt-4 mt-lg-0">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="{{ asset ('front/assets/img/doctors/doctors-2.jpg') }}" class="img-fluid"
                  alt=""></div>
              <div class="member-info">
                <h4>Sarah Jhonson</h4>
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="{{ asset ('front/assets/img/doctors/doctors-3.jpg') }}" class="img-fluid"
                  alt=""></div>
              <div class="member-info">
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="{{ asset ('front/assets/img/doctors/doctors-4.jpg') }}" class="img-fluid"
                  alt=""></div>
              <div class="member-info">
                <h4>Amanda Jepson</h4>
    ...
    <section id="contact" class="contact">
      ...
      <div>
        <iframe style="border:0; width: 100%; height: 350px;"
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3954.470756418919!2d111.5101985147771!3d-7.632414894496937!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e79be5ce07669cb%3A0x6462c2db10ba91d7!2sRumah%20Sakit%20Islam%20Siti%20Aisyah%20Madiun!5e0!3m2!1sid!2sid!4v1684293189823!5m2!1sid!2sid"
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Lokasi:</h4>
                <p>Jl. Mayjen Sungkono No.38, RW.40 <br>
                  Nambangan Lor,Kec.Manguharjo,Kota Madiun<br>
                  Jawa Timur 63129 <br></p>
              </div>
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>RSI Siti Aisyah madiun</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
